...
export default class MeteorScreen extends Component {
                ...
                <ImageBackground source={bg_img} style={styles.backgroundImage}>
                    <View styles={styles.gifContainer}>
                        ...
                        <View>
                            ...
                            <Text style={[styles.cardText, { marginTop: -50, marginLeft: 50 }]}>Closest to Earth - {item.close_approach_data[0].close_approach_date_full}</Text>
    ...
    render() {
        ...
        if (Object.keys(this.state.meteors).length === 0) {
            ...
            meteors = meteors.slice(0, 5) //we only need the first 5
